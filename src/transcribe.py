...
def cli():
    ...
    hot_words = """The following words will appear in this video: 
                openEuler eulerMaker RISC-V infrastructure qemu maintainer committer kernel
                TC,AI for compiler,CVE漏洞,hello github gitea gitcode spec文件,kernel sig,ARM,X86,
                龙芯 PR或isssues yaml
                """
    asr_options = {
